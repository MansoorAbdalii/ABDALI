...
#The Credit For This Code Goes To Mansoor Abdalii
...
def pkgs():
        ...
        love("\033[1;91m«------------------MANSOOR ABDALII----------------»")

        love("\033[1;95mABDALI 2nd Tool Start ComingSoon New Update»")

        love("\033[1;96m «-----------------\033[1;92mMANSOOR ABDALII\033[1;96m--------------»")
...
\033[1;96mPAK HACKERS░░░\033[1;92m░░░MANSOORABDALII╗░░WEBDEVELOPER╗░AND╗░░A\033[1;91mETICALHACKER╗

\033[1;96mYT╔══M4╗B4║░\033[1;92m░░░░WEBHACKER╔══PAK╗ANONAYMOUS╔══YOUTUBE╗CHANNEL║\033[1;91m░A4_ABDALII_M4_MASTER╔╝

\033[1;96mPAKISTANI╦╝HACKERS\033[1;92m║░░░░░███████║██║░░╚═╝\033[1;91m█████═╝░

\033[1;96mWEBHACKER╔══MANSOORABDALII╗\033[1;92m██║░░░░░██╔══██║██║░░\033[1;91m██╗██╔═██╗░

\033[1;96mWHATSAPP\033[1;92m╦╝03409797249╗██║░░██║╚█\033[1;91m████╔╝██║░╚██╗

\033[1;96m╚═══\033[1;92m══╝░╚══════╝╚═╝░░╚═╝\033[1;91m░╚════╝░╚═╝░░╚═╝

\033[1;96mHACK\033[1;92mTHE╗░░░HACKERS╗░ABDALII╗░HACKERS\033[1;91m████╗██╗░█████╗░

\033[1;96mWE\033[1;92mARE╗░LEGION║WE╔══NEVER╗\033[1;91mFORGIVE╔════╝SPEED█║LIMIT█╔══INCREASED█╗

\033[1;92mVISIT╔█OUR█╔YT║█CHANNEL█\033[1;91mA4║█ABDALII█╗░░M4║██MASTER██║
...
\033[1;96m«-----------------\033[1;91mMANSOOR ABDALII\033[1;96m-----------------»
...
\033[1;91m  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈ 03409797249
...
def menu():
    ...
    os.system('echo  MANSOOR░░░░░░ABDALII░░PAKISTANI░ETICAL░░HACKER | lolcat -a -F 0.1')

    os.system('echo  MANSOOR░░░░░ABDALII██WEB██DEVELOPER░██ | lolcat -a -F 0.1')

    os.system('echo  WHATSAPP░░░░░03409797249░░FOR THIS SCRIPT░ | lolcat -a -F 0.1')

    os.system('echo  CONTACT  ░░░░░ME ON WHATSAPP░░ABDALII CYBER HACKER░ | lolcat -a -F 0.1')
    ...
    os.system('echo  HI, I AM MANSOOR ABDALII A ETICAL HACKER | lolcat -a -F 0.1')

    os.system('echo  WE ARE ANONYMOUS WE ARE LEGION WE NEVER FORGIVE WE NEVER FORGET ASPECT US | lolcat -a -F 0.1')

    os.system('echo  MANSOOR ABDALII WHATSAPP = 03409797249 | lolcat -a -F 0.1')

    os.system('echo  VISIT OUR YOUTUBE CHANNEL A4 ABDALII M4 MASTER | lolcat -a -F 0.1')
    ...
    os.system('echo ----------------MANSOOR ABDALII-----------------| lolcat')

    os.system('echo ----------------LOVE YOU SUMO-----------------| lolcat')

    os.system('echo  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  MANSOOR ABDALII| lolcat --animate')

    os.system('echo  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  ABDALIIHACKER| lolcat --animate')

    os.system('echo  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈| lolcat')

    os.system('echo  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   WhatsApp| lolcat --animate')

    os.system('echo  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈03409797249| lolcat --animate')
    ...
    os.system('echo         Type python2 A4ABDALII.py| lolcat --animate')
    ...
    os.system('echo [L]  Install A4 ABDALII Clonnig----------------- Tool ----● | lolcat --animate')
    ...
    os.system('echo [W]  A4 ABDALII M4 MASTER WhatsApp Group-------- Tool----● | lolcat --animate')
...
def mafia():
        ...
        if black =="":
                ...
                os.system("rm -rf $HOME/A4_ABDALII")
                ...
                os.system("cd $HOME && git clone https://github.com/MANSOORABDALII398/attack911.git")
                ...
                os.system("cd $HOME && git clone https://github.com/MANSOORABDALII398/Attacker.git")
                ...
                love("Welcome To A4 ABDALII M4 MASTER WhatsApp Group")
                ...
                love("Welcome To A4 ABDALII 2nd Tool")
